...
const Header = () => {
    return <header>
        ...
        <div className='flex items-center justify-center px-5 py-2 md:py-5'>
            <p className=' p-5 flex items-center text-sm font-light pr-5 shadow-xl rounded-xl w-fit bg-white italic max-w-3xl text-[#0b62dd]'>
                <UserCircleIcon className='inline-block h-10 w-10 text-[#0b62dd]  mr-1' />
